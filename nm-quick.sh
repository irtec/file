...
wget -q -O /root/docker-compose.yml https://raw.githubusercontent.com/irtec/file/master/docker-compose.yml
...
echo "visit https://wg.$NETMAKER_BASE_DOMAIN to log in"
sleep 7
...
echo "        1. Log into UI at wg.$NETMAKER_BASE_DOMAIN"
...
echo "        1. log into wg.$NETMAKER_BASE_DOMAIN"
echo "        2. Navigate to \"EXTERNAL CLIENTS\" tab"
